    ...
    return (
        <>
            <div className='main gap-6 text-black'>
                ...
                <div className='p-4 bg-gradient-to-r from-[#4468A1] to-[#706a6a] gap-2 flex flex-col w-full'>
                ...
                <div className='bg-gradient-to-r from-[#F6F6F6] to-[#D0D7E2] rounded-t-2xl p-4 w-full h-full -mt-10 flex flex-col gap-4 lg:items-center '>
                    <h1 className='text-h1 self-center'> Popular Campaigns</h1>
                    <select name="categories" id="categories" className='px-4 py-4 text-p w-full rounded-xl border-r-8 border-transparent outline outline-neutral-700 max-w-[500px] self-center'>
                        <option value="categories">All categories</option>
                    </select>
                    <div className='grid grid-cols-1 gap-4 lg:grid-cols-2'>
                        <div className='bg-white flex rounded-xl flex-col gap-4 max-h-[100vh] max-w-full pb-6'>
                            <Image src={img1} alt='card-image' className='w-full' />
                ...
                <button className='button max-w-full mb-4'> See More Campaign </button>
            </div>
        </>
    )
}
